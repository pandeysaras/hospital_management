class ProfileUploadReponseModel {
  bool? status;
  String? message;
  User? user;
  String? steps;

  ProfileUploadReponseModel({this.status, this.message, this.user, this.steps});

  ProfileUploadReponseModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
